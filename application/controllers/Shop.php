...
class Shop extends MY_Controller
{
    public function sortBy($sort, $page = null)
    {
        ...
        $data['content'] = $this->shop->select(
            [
                'product.id', 'product.title AS product_title', 'product.description', 'product.image', 'product.price', 'product.image', 'product.is_available',
    ...
    public function category($category, $page = null)
    {
        ...
        $data['pagination'] = $this->shop->makePagination(base_url("shop/sortby/$category"), 4, $data['total_rows']);
    ...
    public function search($page = null)
    {
        ...
        $data['content'] = $this->shop->select(
            [
                'product.id', 'product.title AS product_title', 'product.image', 'product.price', 'product.image', 'product.is_available',
        ...
        $data['total_rows'] = $this->shop->like('title', $keyword)->count();
